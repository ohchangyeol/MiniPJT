...
<body>
	...
	<div class="container">
		...
		<div class="page-header">
	       <h3 class=" text-info">상품 수정 내역</h3>
	    </div>
		...
		<div class="row">
	  		<div class="col-md-12 text-center ">
	  			<button type="button" class="btn btn-primary revise-btn">재수정</button>
                <button type="button" class="btn btn-primary ckeck-btn">확 인</button>
	  		</div>
		</div>
