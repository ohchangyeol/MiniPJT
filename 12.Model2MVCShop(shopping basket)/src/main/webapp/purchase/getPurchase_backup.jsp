...
<%--
Purchase purchase = (Purchase)request.getAttribute("pruchase");
User user = purchase.getBuyer();
Product productVo = purchase.getPurchaseProd();

--%>

<c:set var = "buyer" value ="${purchase.buyer}"></c:set>
