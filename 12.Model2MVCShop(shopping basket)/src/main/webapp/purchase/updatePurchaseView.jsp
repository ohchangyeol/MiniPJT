	...
	<div class="container">
		...
		<form name="detailForm" class="form-horizontal">
          ...
          <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="divyDate" name="divyDate" placeholder="제조 일자를 선택해주세요." value="${purchase.divyDate}">
		    </div>
		  </div>
          <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <!-- <input type="text" class="form-control" id="prodDetail" placeholder="상세정보"> -->
              <textarea name="divyRequest" class="form-control" rows="3" placeholder="배송시 요청 사항 입력해주세요.">${purchase.divyRequest}</textarea>
		    </div>
		  </div>
