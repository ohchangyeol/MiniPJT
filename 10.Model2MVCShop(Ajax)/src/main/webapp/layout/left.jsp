		...
		//==> jQuery 적용 추가된 부분
		 $(function() {
			...
			//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
		 	...
		 	$( ".product-list-search" ).on("click" , function() {
				//Debug..
				//alert(  $( ".Depth03:contains('회원정보조회')" ) );
		 		$(window.parent.frames["rightFrame"].document.location).attr("href","/product/listProduct?menu=search");
			});
		 	
		 	$( ".purchase-list" ).on("click" , function() {
				//Debug..
				//alert(  $( ".Depth03:contains('회원정보조회')" ) );
...
<tr>
	<td valign="top"> 
		<table  border="0" cellspacing="0" cellpadding="0" width="159">
			<tr>
				<td class="Depth03 product-list-search">
					상 품 검 색
				</td>
			</tr>
			...
			<tr>
				<td class="Depth03 purchase-list">
					구매이력조회
				</td>
			</tr>
			</c:if>
			...
			<tr>
				<td class="Depth03 histroy-btn">최근 본 상품</td>
			</tr>
		</table>
	</td>
</tr>
