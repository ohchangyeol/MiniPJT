...
<%
	...
	// System.out.println("=======================serarch"+searchVO);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	%>
		...
		%>
			...
			<input 	type="text" name="searchKeyword"  value="<%if(!searchVO.getSearchKeyword().equals("null")){ %><%=searchVO.getSearchKeyword()%><%}%>" 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		...
		%>
			<a href="/listUser.do?page=<%=i%>&searchKeyword=<%=request.getParameter("searchKeyword")%>&searchCondition=<%= request.getParameter("searchCondition")%>"><%=i %></a>
		<%
			}
		%>	
    	</td>
