	...
	<div class="container">
		...
		<form name="detailForm" class="form-horizontal" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="prodName" value="${product.prodName}" name="prodName"placeholder="상품 명을 입력 해주세요.">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="date_"value="${product.manuDate}" name="manuDate" placeholder="제조 일자를 선택해주세요.">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="input-group">
		      <input type="text" class="form-control" id="price" value="${product.price}"name="price"  placeholder="상품 가격">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      ...
		      <textarea name="prodDetail" class="form-control" rows="3" placeholder="상품 상세 정보를 입력해주세요">${product.prodDetail}</textarea>
		    </div>
		  </div>
		  <div class="form-group">
