...
//		 
	 ...
	 public String updateUser(@ModelAttribute("product") Product product, @RequestParam("file") MultipartFile file,HttpServletRequest req, Model model) throws Exception{
